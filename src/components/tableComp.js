...
import '../index.css';
import { Table, Tag, Radio, Space, Typography, Layout } from 'antd';
import { DeleteOutlined, EditOutlined, EyeOutlined, MailOutlined, PrinterOutlined } from '@ant-design/icons';
  ...
  },
  {
    ...
    render: (text, record) => (
      <Space size="middle">
        ...
        <PrinterOutlined width="20em" height={20}  style={{color:'#F87060',}}/>
      </Space>
    ),
  },
];
...
const CustomerTable =()=> {
    ...
    return (
      <Layout style={{boxShadow: "0px 9px 16px rgba(159, 162, 191, 0.18), 9px 0px 16px rgba(159, 162, 191, 0.18)"}}>
